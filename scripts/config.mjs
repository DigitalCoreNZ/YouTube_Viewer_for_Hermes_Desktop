...
/**
 * Plugin configuration CLI for Hermes Desktop YouTube Viewer.
 *
 * Reads/writes config.json in HERMES_PLUGIN_DATA (or cwd fallback).
...
function getConfigPath() {
  const dataDir = process.env.HERMES_PLUGIN_DATA;
...
function cmdShow() {
  ...
  console.log('YouTube Viewer Plugin Settings\n');
...
if (args.includes('--path')) {
  ...
  console.log('YouTube Viewer Plugin Config\n');
